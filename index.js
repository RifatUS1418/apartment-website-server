...
async function run() {
    try {
        ...
        // GET All Orders API
        app.get('/customers_data/orders', async (req, res) => {
        ...
        // PUT status update API
        // app.put('/customers_data/:id', async (req, res) => {
        //     const id = req.params.id;
        //     // const user = req.body;
        //     // console.log(user);
        //     const filter = { _id: ObjectId(id) };
        //     console.log(filter);
        //     const query = { status: { $regex: "Panding" } };
        // })
        ...
        // DELETE Apartments API for admin
